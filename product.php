	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Gerenciamento de Produto</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> Novo Produto </button>
				</div> <!-- /div-action -->				
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="form-group">
	        	<label for="productImage" class="col-sm-3 control-label">Imagem: </label>
	        ...
	        <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Avaliação: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-primary" id="createProductBtn" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> Salvar</button>
	      </div> <!-- /modal-footer -->	      
     	</form> <!-- /.form -->	     
    </div> <!-- /modal-content -->    
  </div> <!-- /modal-dailog -->
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <ul class="nav nav-tabs" role="tablist">
				    ...
				    <li role="presentation"><a href="#productInfo" aria-controls="profile" role="tab" data-toggle="tab">Informação</a></li>    
				  </ul>
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="photo">
				    	...
				    	<div class="form-group">
			        	<label for="editProductImage" class="col-sm-3 control-label">Foto: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">							    				   
				    ...
				    <div role="tabpanel" class="tab-pane" id="productInfo">
				    	...
				    	<div class="form-group">
			        	<label for="editProductName" class="col-sm-3 control-label">Nome: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
			        ...
			        <div class="form-group">
			        	<label for="editRate" class="col-sm-3 control-label">Avaliação: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
			        ...
			        <div class="modal-footer editProductFooter">
				        ...
				        <button type="submit" class="btn btn-success" id="editProductBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> Salvar</button>
				      </div> <!-- /modal-footer -->				     
			        </form> <!-- /.form -->				     	
				    </div>    
				    <!-- /product info -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer removeProductFooter">
        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> Cancelar</button>
        <button type="button" class="btn btn-primary" id="removeProductBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> Remover</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
