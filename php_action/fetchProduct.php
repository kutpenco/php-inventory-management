...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
 	...
 	if($row[7] == 1) {
 		...
 		// deactivate member
 		$active = "<label class='label label-danger'>Não Disponivel</label>";
 	} // /else
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	  	<li><a type="button" data-toggle="modal" id="seeProductModalBtn" data-target="#seeProductModal" onclick="seeProduct('.$productId.')"> <i class="glyphicon glyphicon-edit"></i> Ver</a></li>
